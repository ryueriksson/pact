      ...
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden mb-5">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="border-t border-gray-100 pt-4 flex items-center justify-between">
            ...
            <a href="#pricing" className="text-xs text-sky-600 font-semibold hover:text-sky-700">
              Upgrade →
            </a>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="bg-sky-50 border border-sky-100 rounded-xl p-4 mb-5">
                <p className="text-xs text-sky-700 leading-relaxed">
                  <strong>How it works:</strong> When a tenant pays through their lease link,
                  the money goes directly to your Stripe account. Pact takes a 1.5% platform fee.
                  Stripe charges 2.9% + 30¢ for cards or 0.8% (max $5) for ACH bank transfers.
                </p>
              </div>
