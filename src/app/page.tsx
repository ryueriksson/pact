  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] text-gray-900 antialiased">
      ...
      <header className="sticky top-0 z-50 bg-[#FAFAF9]/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/signup"
              className="text-sm bg-violet-600 hover:bg-violet-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors shadow-sm"
            >
              Get started free
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden pt-20 pb-28">
        {/* Gradient orbs */}
        <div className="absolute -top-40 -right-32 w-[600px] h-[600px] bg-violet-200 rounded-full blur-3xl opacity-30 pointer-events-none" />
        <div className="absolute -bottom-20 -left-32 w-[500px] h-[500px] bg-indigo-200 rounded-full blur-3xl opacity-20 pointer-events-none" />

        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-violet-50 border border-violet-200 text-violet-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-8 uppercase tracking-wide">
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tight text-gray-900 mb-6 leading-[1.08]">
            ...
            <span className="relative ml-3">
              <span className="relative z-10 text-violet-600">one link.</span>
              <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 12" fill="none">
                <path d="M2 9C60 3 120 1 150 2C180 3 240 7 298 9" stroke="#C4B5FD" strokeWidth="4" strokeLinecap="round"/>
              </svg>
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/signup"
              className="w-full sm:w-auto bg-violet-600 hover:bg-violet-700 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-lg shadow-violet-200 hover:shadow-violet-300 hover:-translate-y-0.5"
            >
              Start for free →
            </Link>
          ...
          <div className="mt-16 flex items-center justify-center gap-2 text-sm text-gray-400">
            <div className="flex -space-x-2">
              {["bg-violet-400","bg-indigo-400","bg-blue-400","bg-purple-400","bg-fuchsia-400"].map((c,i) => (
        ...
        <div className="relative max-w-3xl mx-auto px-6 mt-16">
          <div className="bg-white rounded-2xl shadow-2xl shadow-gray-200 border border-gray-100 overflow-hidden">
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  {["Review","Sign","Pay"].map((s, i) => (
                    <span key={s} className={`text-xs px-2.5 py-1 rounded-full font-semibold ${i === 0 ? "bg-violet-100 text-violet-700" : "bg-gray-100 text-gray-400"}`}>{s}</span>
                  ))}
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-violet-50 rounded-xl flex items-center justify-between">
                <div>
                  <p className="text-xs text-violet-500 font-medium">Deposit due</p>
                  <p className="text-2xl font-black text-violet-700">$1,500</p>
                </div>
                <div className="bg-violet-600 text-white text-sm font-bold px-5 py-2.5 rounded-lg shadow-md shadow-violet-200">
                  Review & Sign →
                </div>
              </div>
            </div>
      ...
      <section id="how-it-works" className="py-24 bg-white border-y border-gray-100">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative">
            {/* Connector line */}
            <div className="hidden md:block absolute top-8 left-[16.5%] right-[16.5%] h-0.5 bg-gradient-to-r from-violet-200 via-indigo-200 to-purple-200" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-white border-2 border-gray-100 rounded-2xl p-8">
              ...
              <Link
                href="/signup"
                className="block text-center border-2 border-gray-200 text-gray-700 hover:border-violet-300 hover:text-violet-700 px-6 py-3 rounded-xl font-bold transition-all"
              >
                Get started
              </Link>
            </div>
            ...
            {/* Pro */}
            <div className="bg-violet-600 border-2 border-violet-600 rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-xs font-bold text-violet-200 uppercase tracking-widest mb-3">Pro</div>
                <div className="text-5xl font-black text-white mb-1">$29</div>
                <div className="text-sm text-violet-200 mb-8">per month</div>
                <ul className="space-y-3 mb-8">
                  {[
                    "Unlimited proposals",
                ...
                <Link
                  href="/signup"
                  className="block text-center bg-white text-violet-700 hover:bg-violet-50 px-6 py-3 rounded-xl font-bold transition-all shadow-lg"
                >
                  Start free trial
                </Link>
              </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-violet-600 to-indigo-600 rounded-3xl p-12 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <Link
              href="/signup"
              className="inline-block bg-white text-violet-700 hover:bg-violet-50 px-10 py-4 rounded-xl font-black text-lg transition-all shadow-2xl"
            >
      ...
      <footer className="border-t border-gray-100 py-12 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} Pact. Built for closers.
          </p>
        </div>
      </footer>
