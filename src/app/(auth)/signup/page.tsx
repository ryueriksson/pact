...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] flex">
      {/* Left panel */}
      <div className="hidden lg:flex flex-col w-[480px] bg-gradient-to-br from-violet-600 to-indigo-700 p-12 relative overflow-hidden flex-shrink-0">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 bg-white/20 rounded-xl flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 40 40" fill="none">
                ...
                <path d="M14 30 Q20 26 28 29" stroke="#C4B5FD" strokeWidth="2.5" strokeLinecap="round"/>
              </svg>
            </div>
              ...
              {[
                ...
                <div key={t.author} className="bg-white/10 rounded-2xl p-5 backdrop-blur-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-full bg-violet-300 flex items-center justify-center text-xs font-bold text-violet-800">
                      {t.author[0]}
                    </div>
                    <div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-violet-300 rounded-xl px-4 py-3 text-sm font-semibold text-gray-700 transition-all hover:shadow-sm mb-6"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full border-2 border-gray-200 focus:border-violet-400 rounded-xl px-4 py-3 text-sm outline-none transition-colors bg-white"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-violet-600 hover:bg-violet-700 text-white py-3.5 rounded-xl font-bold text-sm transition-all disabled:opacity-50 shadow-lg shadow-violet-100 hover:shadow-violet-200 mt-2"
            >
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/login" className="text-violet-600 font-bold hover:text-violet-700">
              Sign in
            </Link>
          </p>
        </div>
